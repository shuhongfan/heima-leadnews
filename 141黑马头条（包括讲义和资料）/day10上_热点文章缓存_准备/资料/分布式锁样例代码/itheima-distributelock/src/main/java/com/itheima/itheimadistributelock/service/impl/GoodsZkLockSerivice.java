...
import com.itheima.itheimadistributelock.core.zk.ZKDistributeImproveLock;
import com.itheima.itheimadistributelock.core.zk.ZKDistributeLock;
...
@Service("goodsZkService")
@Scope("prototype")
public class GoodsZkLockSerivice implements GoodsService {
	@Autowired
	private GoodStockDao goodStockDao;
//	Lock lock = new ZKDistributeLock("/zookeeperlock");
	Lock lock = new ZKDistributeImproveLock("/zookeeperlock");
